...
public class GameStub1 extends Game {
    ...
    public GameStub1() throws IOException, InvalidReadException, NoSuchPlayerException {
        super(null);
    ...
    public GameStub1(DevelopmentCardSetStub1 developmentCardSet) throws IOException, InvalidReadException, NoSuchPlayerException {
        super(null);
        faithpath = new FaithPathStub1();
        market = new MarketStub1();
